...
// sign in & sign up function with modal

        function openModal(signinModal) {
            document.getElementById(signinModal).style.display = 'flex';
        }

        function closeModal(signinModal) {
        ...
        // password & confirm Password
            ...
            document.querySelector('#signupModal form').onsubmit = function(event) {
